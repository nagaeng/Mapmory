...
class NextScreen3 extends StatefulWidget {
  const NextScreen3({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  NextScreen3State createState() => NextScreen3State();
}

class NextScreen3State extends State<NextScreen3> {
  bool isImageChanged1 = false;
  bool isImageChanged2 = false;
  @override
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: TextButton(
                    onPressed: () {
                      setState(() {
                        isImageChanged1 = !isImageChanged1;
                      });
                    },
                    child: Image.asset(isImageChanged1
                        ? 'assets/image/bar5.png'
                        : 'assets/image/bar4.png'),
                  ),
                ),
                Positioned(
                  left: 310,
                  ...
                  child: TextButton(
                    onPressed: () {
                      setState(() {
                        isImageChanged2 = !isImageChanged2;
                      });
                    },
                    child: Image.asset(isImageChanged2
                        ? 'assets/image/bar5.png'
                        : 'assets/image/bar4.png'),
                  ),
                ),
