...
//import '_1login.dart';
class NextScreen5 extends StatefulWidget {
  const NextScreen5({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  NextScreen5State createState() => NextScreen5State();
}

class NextScreen5State extends State<NextScreen5> {
  @override
