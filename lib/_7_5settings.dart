...
import '_7_1reset_password.dart';
import '_7_2connected_email.dart';

//import '_3_3writing.dart';
//import '_1login.dart';
class NextScreen4 extends StatefulWidget {
  const NextScreen4({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  NextScreen4State createState() => NextScreen4State();
}

class NextScreen4State extends State<NextScreen4> {
  String connectedEmail = 'example@example.com';
  @override
          ...
          Container(
            ...
            child: Stack(
              children: [
                ...
                const Positioned(
                  left: 0, // Update left to 0 to center horizontally
                  right: 0, // Update right to 0 to center horizontally
                  top: 75,
                  child: Text(
                    '보안',
