...
class NextScreen2 extends StatefulWidget {
  const NextScreen2({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  NextScreen2State createState() => NextScreen2State();
}

class NextScreen2State extends State<NextScreen2> {
  @override
